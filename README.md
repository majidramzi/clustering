...
| :--- | :--- | :--- |
| **[Mall Customer Segmentation](https://www.kaggle.com/datasets/vjchoudhary7/customer-segmentation-tutorial-in-python)** | First exercise | Just 200 customers. Income and spending score make clusters easy to plot and discuss. |
| **[Wholesale Customers](https://www.kaggle.com/datasets/binovi/wholesale-customers-data-set)** | Next step | Spending across product categories gives students a practical reason to scale variables and interpret customer groups. |
